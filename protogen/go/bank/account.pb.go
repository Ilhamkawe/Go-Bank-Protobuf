...
type CurrentBalanceResponnse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CurrentBalanceResponnse) Reset() {
	*x = CurrentBalanceResponnse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CurrentBalanceResponnse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CurrentBalanceResponnse) ProtoMessage() {}

func (x *CurrentBalanceResponnse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_bank_type_account_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CurrentBalanceResponnse.ProtoReflect.Descriptor instead.
func (*CurrentBalanceResponnse) Descriptor() ([]byte, []int) {
	return file_proto_bank_type_account_proto_rawDescGZIP(), []int{1}
}

func (x *CurrentBalanceResponnse) GetAmount() float64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *CurrentBalanceResponnse) GetCurrentDate() *date.Date {
	if x != nil {
...
var file_proto_bank_type_account_proto_rawDesc = []byte{
	...
	0x62, 0x65, 0x72, 0x22, 0x67, 0x0a, 0x17, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x42, 0x61,
	0x6c, 0x61, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x6e, 0x73, 0x65, 0x12, 0x16,
	0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06,
	0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x34, 0x0a, 0x0c, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e,
	...
	0x0b, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x44, 0x61, 0x74, 0x65, 0x42, 0x38, 0x5a, 0x36,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x49, 0x6c, 0x68, 0x61, 0x6d,
	0x6b, 0x61, 0x77, 0x65, 0x2f, 0x47, 0x6f, 0x2d, 0x42, 0x61, 0x6e, 0x6b, 0x2d, 0x50, 0x72, 0x6f,
...
var file_proto_bank_type_account_proto_goTypes = []any{
	...
	(*CurrentBalanceResponnse)(nil), // 1: bank.CurrentBalanceResponnse
	(*date.Date)(nil),               // 2: google.type.Date
}
var file_proto_bank_type_account_proto_depIdxs = []int32{
	2, // 0: bank.CurrentBalanceResponnse.current_date:type_name -> google.type.Date
...
func file_proto_bank_type_account_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_bank_type_account_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*CurrentBalanceResponnse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
